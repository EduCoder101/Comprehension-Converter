 ...
 *   doOptions(e) – responds to CORS preflight so POSTs from test pages on other origins (e.g. GitHub Pages) succeed.
 */
...
/** Respond to CORS preflight so POSTs from test pages on other domains succeed. */
